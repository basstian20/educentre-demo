...
function ClassSchedule() {
  ...
  const classes = [
    ...
    {day:5,start:5,span:2,name:"Math Yr 6",room:"Room A",teacher:"Noor Kesuma",color:"#3b82f620",border:C.blue},
    {day:5,start:1,span:2,name:"Science Yr 5",room:"Lab 1",teacher:"Laila Wihasfina",color:"#f59e0b20",border:C.amber},
  ];
  const cellH = 44;
  return (
